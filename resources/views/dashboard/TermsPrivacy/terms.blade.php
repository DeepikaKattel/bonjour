...
<h2>Welcome to Bonjour!</h2>
    <p>These terms and conditions outline the rules and regulations for the use of Bonjour Management Pvt Ltd.'s Website,
        located at https://www.bonjour.com.np.</p>
    <p>By accessing this website, we assume you accept these terms and conditions. Do not continue to use Bonjour if
        you do not agree to take all of the terms and conditions stated on this page. Our Terms and Conditions were
        created with the help of the Terms And Conditions Generator.</p>
...
<h3>Cookies</h3>
    <p>We employ the use of cookies. By accessing Bonjour, you agreed to use cookies in agreement with the Bonjour
        Management Pvt Ltd.'s Privacy Policy.</p>
...
<h3>License</h3>
    <p>Unless otherwise stated, Bonjour Management Pvt Ltd. and/or its licensors own the intellectual property rights
        for all material on Bonjour. All intellectual property rights are reserved. You may access this from Bonjour
        for your own personal use subjected to restrictions set in these terms and conditions.</p>
<p>You must not:</p>
<ul id="ul">
    <li>Republish material from Bonjour</li>
    <li>Sell, rent or sub-license material from Bonjour</li>
    <li>Reproduce, duplicate or copy material from Bonjour</li>
    <li>Redistribute content from Bonjour</li>
</ul>


<p>This Agreement shall begin on the date hereof.</p>
    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas of the website. Bonjour Management Pvt Ltd. does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and opinions of Bonjour Management Pvt Ltd.,
        its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Bonjour Management Pvt Ltd. shall not be liable for the
    ...
    <p>Bonjour Management Pvt Ltd. reserves the right to monitor all Comments and to remove any Comments which can be
...
<p>You hereby grant Bonjour Management Pvt Ltd. a non-exclusive license to use, reproduce, edit and authorize others to
...
<p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
    ...
    with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Bonjour Management
...
<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
    must inform us by sending an e-mail to Bonjour Management Pvt Ltd.. Please include your name, your organization
    name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to
    our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</p>
...
<p>No use of Bonjour Management Pvt Ltd.'s logo or other artwork will be allowed for linking absent a trademark license
    agreement.</p>
...
<p style="font-weight: bold">Content Liability</p>
   <p> We shall not be hold responsible for any content that appears on your Website. You agree to protect and defend
       ...
       interpreted as libelous, obscene or criminal, or which infringes, otherwise violates, or advocates the infringement
...
<p style="font-weight: bold">Removal of links from our website</p>
...
<ul id="ul"> 
   ...
   <p> The limitations and prohibitions of liability set in this Section and elsewhere in this disclaimer: (a) are
       subject to the preceding paragraph; and (b) govern all liabilities arising under the disclaimer, including liabilities
